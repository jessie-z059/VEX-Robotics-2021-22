...
public:
    ...
    double calculate(double target, double measured_value, double dt) {
        while (measured_value >= output_min && measured_value <= output_max) {
            ...
            // TODO: Implement integral term calculation with anti-windup mechanism
            // HINT: Only accumulate integral if output is within limits
            integral = integral + error * dt;
            double Iout = ki * integral;

            // Calculate derivative term with filtering
            // TODO: Implement derivative calculation with optional filtering
            // HINT: Use the smoothing factor alpha to filter the derivative
            double derivative = (error - previous_error)/dt;
            double Dout = kd * derivative * alpha;

            // Update the last derivative value if using filtering
            // TODO: Update last_derivative using a smoothing technique
            last_derivative = derivative;
            
            // TODO: Calculate total output
            output = Pout + Iout + Dout;

            // Clamp output to min and max limits
            // TODO: Implement output clamping
   ...
   void reset() {
       // TODO: Reset integral and previous error to initial state
       integral = 0.0;
       previous_error = 0.0;
...
int main() {
   ...
   return 0;
        ...
        // TODO: Calculate total output
        double output = Pout + ki * integral + kd * derivative
...
void drive_straight (double target, double speed){
    ...
    //set drive motors to zero at the start
